package org.vaadin.app.views.main;
...
@PWA(name = "ExampleApp", shortName = "ExampleApp", enableInstallPrompt = false)
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "ExampleApp logo"));
        logoLayout.add(new H1("ExampleApp"));
